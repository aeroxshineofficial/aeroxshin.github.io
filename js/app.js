...
/* ===== FIRESTORE INIT ON CUSTOMER SITE ===== */
function initCustomerFirestore() {
  if (typeof FirebaseServicesReady === "undefined" || !FirebaseServicesReady) {
    return;
  }

  loadProductsFromFirestore().then(function(loaded) {
    if (loaded) {
